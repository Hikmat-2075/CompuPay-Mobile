...
class ApiConfig {
  ...
  static String get leaveRequest {
    final endpoint =
        dotenv.env['LEAVE_REQUEST_ENDPOINT'];
  ...
  static String get payroll {
    final payrollEndpoint =
        dotenv.env['PAYROLL_ENDPOINT'];

    if (payrollEndpoint != null &&
        payrollEndpoint.trim().isNotEmpty) {
